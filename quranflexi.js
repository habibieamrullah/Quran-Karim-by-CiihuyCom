...
function navigateGo(){
	...
	if(surahToGo != "") window.location.href = "https://ciihuy.com/qurankarim/index.php?lang=" + lang + "&surah=" + surahToGo;
}
...
function showDonateBtn(x){
	if(x == 1){
		document.write("<p align='center'><a href='https://ciihuy.com/qurankarim/index.php?donate'><img src='donate.png' width='114px' /></a></p>");
	}
}

function goToSurahList(){
	window.location = "https://ciihuy.com/qurankarim/index.php?lang=" + lang;
}